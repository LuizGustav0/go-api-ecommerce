...
import (
	...
	"github.com/LuizGustav0/goapi-ecommerce/internal/entity"
	"github.com/LuizGustav0/goapi-ecommerce/internal/service"
...
func (wch *WebProductHandler) GetProductByCategoryID(w http.ResponseWriter, r *http.Request) {
	...
	products, err := wch.ProductService.GetProductByCategory(categoryID)
